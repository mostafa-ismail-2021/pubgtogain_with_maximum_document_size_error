...
export class FreeAdDuoPubgComponent implements OnInit ,OnDestroy {
  ...
  addFreeAd()
  {
    ...
    this.duoBodyService.getEmailFreeAd(
    ...
    if(userName.valid){
      if(this.oldUserNameValue != filteUserName)
      {
        ...
        this.timeOutUserfullName = setTimeout(function () {
          ...
          $this.checkUserfullName =   $this.duoBodyService.checkUserNameFreeAd($this.oldUserNameValue).subscribe((userNameType)=>{
    ...
    if(gmailAccount.valid){
      if(this.oldGmailAccountValue != filteGmailAccont)
      {
        ...
        this.timeOutGmailAccount = setTimeout(function () {
          ...
          $this.checkGmailAccount =  $this.duoBodyService.checkGmailAccountFreeAd($this.oldGmailAccountValue).subscribe((gmailAccountType)=>{
    ...
    if(youtube.valid){
      if(this.oldYoutubeValue != filteYoutube)
      {
        ...
        this.timeOutYoutube = setTimeout(function () {
          ...
          $this.checkYoutube =  $this.duoBodyService.checkYoutubeFreeAd($this.oldYoutubeValue).subscribe((youtubeType)=>{
