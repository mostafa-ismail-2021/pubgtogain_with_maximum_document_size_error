...
export class SoloreportthehackerComponent implements OnInit ,OnDestroy{
  ...
  addReportHacker()
  {
    this.bodyService.getEmailReportHacker(
    ...
    if(gmailAccount.valid){
      if(this.oldGmailAccountValue != filteGmailAccont)
      {
        ...
        this.timeOutGmailAccount = setTimeout(function () {
          ...
          $this.checkGmailAccount =  $this.bodyService.checkGmailAccountReportHacker($this.oldGmailAccountValue).subscribe((gmailAccountType)=>{
    ...
    if(googleDrive.valid){
      if(this.oldGoogleDriveValue != filtegoogleDrive)
      {
        ...
        this.timeOutGoogleDrive = setTimeout(function () {
          ...
          $this.checkGoogleDrive =  $this.bodyService.checkGoogleDriveReportHacker($this.oldGoogleDriveValue).subscribe((googleDriveType)=>{
