...
export class DuoreportthehackerComponent implements OnInit ,OnDestroy{
  ...
  addReportHacker()
  {
    this.duoBodyService.getEmailReportHacker(
    ...
    if(gmailAccount.valid){
      if(this.oldGmailAccountValue != filteGmailAccont)
      {
        ...
        this.timeOutGmailAccount = setTimeout(function () {
          ...
          $this.checkGmailAccount =  $this.duoBodyService.checkGmailAccountReportHacker($this.oldGmailAccountValue).subscribe((gmailAccountType)=>{
    ...
    if(googleDrive.valid){
      if(this.oldGoogleDriveValue != filtegoogleDrive)
      {
        ...
        this.timeOutGoogleDrive = setTimeout(function () {
          ...
          $this.checkGoogleDrive =  $this.duoBodyService.checkGoogleDriveReportHacker($this.oldGoogleDriveValue).subscribe((googleDriveType)=>{
