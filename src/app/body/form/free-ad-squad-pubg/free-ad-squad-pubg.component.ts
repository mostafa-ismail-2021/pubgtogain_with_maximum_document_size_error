...
export class FreeAdSquadPubgComponent implements OnInit ,OnDestroy{
  ...
  addFreeAd()
  {
    ...
    this.squadBodyService.getEmailFreeAd(
    ...
    if(userName.valid){
      if(this.oldUserNameValue != filteUserName)
      {
        ...
        this.timeOutUserfullName = setTimeout(function () {
          ...
          $this.checkUserfullName =   $this.squadBodyService.checkUserNameFreeAd($this.oldUserNameValue).subscribe((userNameType)=>{
    ...
    if(gmailAccount.valid){
      if(this.oldGmailAccountValue != filteGmailAccont)
      {
        ...
        this.timeOutGmailAccount = setTimeout(function () {
          ...
          $this.checkGmailAccount =  $this.squadBodyService.checkGmailAccountFreeAd($this.oldGmailAccountValue).subscribe((gmailAccountType)=>{
    ...
    if(youtube.valid){
      if(this.oldYoutubeValue != filteYoutube)
      {
        ...
        this.timeOutYoutube = setTimeout(function () {
          ...
          $this.checkYoutube =  $this.squadBodyService.checkYoutubeFreeAd($this.oldYoutubeValue).subscribe((youtubeType)=>{
